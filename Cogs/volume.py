    ...
    async def volume(self, ctx, volume):
        ...
        if (
            ...
            return await ctx.send(
                f"{self.bot.emojiList.false} {ctx.author.mention} The volume have to be a number between 0 and 200!")
        ...
        embed = discord.Embed(title="Volume changed :", description=f"The volumed was changed to : ``{volume} %``",
