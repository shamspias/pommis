...
async def audio_playing(ctx):
    ...
    if client and client.channel and client.source:
        ...
        raise commands.CommandError("currently playing No audio.")
...
async def in_voice_channel(ctx):
    ...
    if voice and bot_voice and voice.channel and bot_voice.channel and voice.channel == bot_voice.channel:
        ...
        raise commands.CommandError("You need to be in the Same channel to do that.")
...
class Music(commands.Cog):
    """Pommis(Bot) commands to help play music."""
    ...
    @commands.command(aliases=["np", "running", "rn"])
    @commands.guild_only()
    @commands.check(audio_playing)
    ...
    @commands.command(aliases=["ply", "P", "p", "Ply", "PLy", "PLY", "pLY", "plY"])
    @commands.guild_only()
    ...
    async def on_reaction_add(self, reaction, user):
        """respond to reactions added to the Pommis's messages, allowing reactions to control playback."""
